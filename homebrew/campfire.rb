class Campfire < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/campfire-net/campfire/releases/download/v0.2.0/cf_darwin_amd64.tar.gz"
      sha256 "760b195f09d39b7ee04c062438e7da21e37ed4f8dfb1ce24fffc2dc023a0a4d4"
    end

    on_arm do
      url "https://github.com/campfire-net/campfire/releases/download/v0.2.0/cf_darwin_arm64.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/campfire-net/campfire/releases/download/v0.2.0/cf_linux_amd64.tar.gz"
      sha256 "36760587259c29b2f027f1fe3d44a17439631e83196e1e8b862aa60c97006879"
    end

    on_arm do
      url "https://github.com/campfire-net/campfire/releases/download/v0.2.0/cf_linux_arm64.tar.gz"
