...
// OpenMemory has moved to store_inmemory.go (campfireagent-c5a, -90f follow-up).
// It is a test helper and lives in its own file so the boundary between
// production and test surface is obvious to reviewers.
