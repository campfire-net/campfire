...
// for the campfire return 404. If the transport was started with a background
// nonce pruner goroutine (via StartNoncePruner), Unregister signals it to stop
// so there is no goroutine leak.
