	...
	tests := []struct {
		...
		},
		{
			...
			msg: store.MessageRecord{
				...
				Tags:        `["finding"]`,
				Antecedents: `["abc123def456abc123def456abc123de"]`,
				Instance:    "cfo",
			},
		...
		},
		{
			...
			msg: store.MessageRecord{
				...
				Tags:        `["decision"]`,
				Antecedents: `["abc123def456abc123def456abc123de","789ghijkl012789ghijkl012789ghijk"]`,
				Instance:    "strategist",
			},
...
func TestFormatDAGOutput(t *testing.T) {
	msgs := []store.MessageRecord{
		...
		},
		{
			...
			Tags:        `["blocker"]`,
			Antecedents: `["789ghijkl012789ghijkl012789ghijk"]`,
			Instance:    "marketing",
			Timestamp:   3000,
		},
		{
			...
			Sender:      "def456789abcdef0",
			Tags:        `["decision"]`,
			Antecedents: `["bbb222ccc333bbb222ccc333bbb222cc"]`,
			Instance:    "strategist",
			Timestamp:   4000,
		},
	}
