...
// This is an inlined version of the relevant part of naming.ResolveContext,
// avoiding the import cycle (naming imports protocol).
func walkUpForCenter(startDir string) string {
	...
	dir := resolved
	for {
		centerPath := filepath.Join(dir, ".campfire", "center")
