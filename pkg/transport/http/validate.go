...
// However, the protocol uses the full 64-byte public key representation in some
// contexts. The canonical campfire_id is 64 lowercase hex characters (32 bytes).
