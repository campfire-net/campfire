...
// validateRelayURLFunc is the active relay URL validation function. Override in
// tests (via OverrideValidateRelayURLForTest) to allow loopback relay endpoints.
var validateRelayURLFunc = validateRelayURLImpl

// OverrideValidateRelayURLForTest disables relay URL validation in tests.
func OverrideValidateRelayURLForTest() {
	validateRelayURLFunc = func(string, bool) error { return nil }
}

// RestoreValidateRelayURL re-enables the real relay URL validation.
func RestoreValidateRelayURL() {
	validateRelayURLFunc = validateRelayURLImpl
}
...
func ValidateRelayURL(relayURL string, allowInsecure bool) error {
	return validateRelayURLFunc(relayURL, allowInsecure)
}

func validateRelayURLImpl(relayURL string, allowInsecure bool) error {
	if relayURL == "" {
