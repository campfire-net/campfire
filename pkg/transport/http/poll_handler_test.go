...
// has no peer_endpoints rows (e.g. freshly created campfire or unknown
// campfire_id). ListPeerEndpoints returns an empty list (no error). The loop
// finds no match → isMember stays false → 403.
