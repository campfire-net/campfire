...
type Membership struct {
	...
	// Used by the rekey handler to verify that only the creator can trigger a rekey.
	// Empty string for legacy records where the creator pubkey was not recorded.
