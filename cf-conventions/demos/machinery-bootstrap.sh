...
#   2. cf-conventions/cf-convention-extension/* (L3 extensions) compile cleanly.
...
check "L3 identity extension builds"  go build ./cf-conventions/cf-convention-extension/identity/...
check "L3 connect extension builds"   go build ./cf-conventions/cf-connect/...
check "L3 delegation extension builds" go build ./cf-conventions/cf-convention-extension/delegation/...
check "L3 billing extension builds"   go build ./cf-conventions/cf-convention-extension/billing/...
...
check "L3 identity extension tests pass"            go test ./cf-conventions/cf-convention-extension/identity/...
check "L3 connect extension tests pass"             go test ./cf-conventions/cf-connect/...
check "L3 delegation extension tests pass"          go test ./cf-conventions/cf-convention-extension/delegation/...
check "L3 billing extension tests pass"             go test ./cf-conventions/cf-convention-extension/billing/...
...
import (
    ...
    "github.com/campfire-net/campfire/cf-conventions/cf-connect"
)
